...
button1 = tk.Button(root, text="PAN Card", font='Helvetica 18 bold', fg="Red", command=lambda: getPanCard())
# button2 = Button(root, text="Driving License", font='Helvetica 18 bold', fg="Blue", command=lambda: getDrivingLicense())
button3 = tk.Button(root, text="Voter ID", font='Helvetica 18 bold', fg="Green", command=lambda: getElection())
button4 = tk.Button(root, text="Exit", font='Helvetica 18 bold', fg="Black", command=lambda: close_window(root))

button1.place(x=20, y=20)
# button2.place(x=20, y=100)
button3.place(x=20, y=100)
button4.place(x=20, y=180)

# button1.pack(side=LEFT)
# button2.pack(side=LEFT)
# button3.pack(side=BOTTOM)
root.title("Convert Image to Text")
root.geometry("300x350+300+350")
root.mainloop()
